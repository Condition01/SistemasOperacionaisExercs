...
public class ThreadCar extends Thread{
	...
	public ThreadCar(int idCarro, Semaphore semafaro) {
	...
	public void carroAndando(){
		...
		while(distanciaPerc < distanciaTotal){
			...
			System.out.println("Carro #" + idCarro + " já andou " + distanciaPerc + "m");
			try {
				Thread.sleep(tempo);
		...
		posicaoChegada++;
		System.out.println("Carro #" + idCarro + "foi o " + posicaoChegada +"o.");
	}
